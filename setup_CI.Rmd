---
title: "How to set up an R package with continuous integration"
output:
  html_document:
    df_print: paged
---

This package pprovdes a quick guide on how to develop an R package from scratch and use Travis CI. A very nice general introduction can be found here:
